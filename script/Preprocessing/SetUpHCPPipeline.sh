...
export HCPPIPEDIR=tools/HCP_Pipelines/HCPpipelines-4.7.0
...
export MSMBINDIR="tools/msm_centos_v3/"
export MATLAB_COMPILER_RUNTIME=software/apps/MATLAB/MATLAB_Runtime/v95
export FSL_FIXDIR=tools/fix
# If a suitable version of wb_command is on your $PATH, CARET7DIR can be blank
export CARET7DIR=tools/workbench/v1.5.0/bin_rh_linux64
export HCPCIFTIRWDIR="$HCPPIPEDIR"/global/matlab/cifti-matlab


## for version > 6.0.4
export FSLDIR=tools/fsl/6.0.6.5
...
# We must stick to freesurfer 6.0.0 for voxel size less than 1 mm T1 image.
export FREESURFER_HOME=tools/freesurfer/6.0.0
